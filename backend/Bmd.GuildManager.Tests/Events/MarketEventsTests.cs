...
public class MarketEventsTests
{
    ...
    public void ItemListed_RoundTrip()
    {
        ...
        var result = JsonSerializer.Deserialize<EventEnvelope<ItemListed>>(json, FunctionJsonOptions.Default);
    ...
    public void ItemSold_RoundTrip()
    {
        ...
        var json = JsonSerializer.Serialize(envelope, FunctionJsonOptions.Default);
        var result = JsonSerializer.Deserialize<EventEnvelope<ItemSold>>(json, FunctionJsonOptions.Default);
    ...
    public void ItemListingCanceled_RoundTrip()
    {
        ...
        var json = JsonSerializer.Serialize(envelope, FunctionJsonOptions.Default);
        var result = JsonSerializer.Deserialize<EventEnvelope<ItemListingCanceled>>(json, FunctionJsonOptions.Default);
